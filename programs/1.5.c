...
int main() //
{
    ...
    priTranVecs[0][0] = 0; priTranVecs[1][0] = 0.5*latticeConstant; priTranVecs[2][0] = 0.5*latticeConstant;
    priTranVecs[0][1] = 0.5*latticeConstant; priTranVecs[1][1] = 0; priTranVecs[2][1] = 0.5*latticeConstant;
    priTranVecs[0][2] = 0.5*latticeConstant; priTranVecs[1][2] = 0.5*latticeConstant; priTranVecs[2][2] = 0;
    
    cellAtomNumber = 2; 
    cellAtomRs[0][0] = 0; cellAtomRs[0][1] = 0; cellAtomRs[0][2] = 0;
    cellAtomRs[1][0] = 0.5*latticeConstant; cellAtomRs[1][1] = 0; cellAtomRs[1][2] = 0;
    cellAtomTypes[0] = 1;
    cellAtomTypes[1] = 2;
