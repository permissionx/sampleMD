...
int main() //
{
    ...
    priTranVecs[0][0] = 1; priTranVecs[1][0] = 1; priTranVecs[2][0] = 1;
    priTranVecs[0][1] = 1; priTranVecs[1][1] = 1; priTranVecs[2][1] = 1;
    priTranVecs[0][2] = 1; priTranVecs[1][2] = 1; priTranVecs[2][2] = 1;
    /*process*/
